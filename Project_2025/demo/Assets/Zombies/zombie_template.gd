...
@export var speed := 80
@export var anim_set := "1"
@export var health := 3  # How much health the zombie has
signal zombie_died
...
func die():
	...
	# Emit signal now (removes warning and works perfectly)
	emit_signal("zombie_died")  # ✅ THIS FIXES THE WARNING

	# Delay before freeing
